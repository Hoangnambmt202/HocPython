...
// const CourseForm = ({ lecturers, categories ,onCourseAdded, onClose }) => {
...
//       // Gửi sự kiện cập nhật danh sách khóa học
...
//       setToast({ show: true, message: "Có lỗi xảy ra khi thêm khóa học", color: "red" });
//     }
//   };
...
//         />
//       )}
//       <h2 className="text-2xl font-bold mb-6 text-gray-800 border-b pb-2">Thêm Khóa Học</h2>
...
//           <button 
//             type="submit" 
//             className="px-4 py-2 bg-blue-600 rounded-md text-white hover:bg-blue-700 transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500"
//           >
//             Thêm khóa học
//           </button>
//         </div>
